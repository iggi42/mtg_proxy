...
This requires a path to a cockatrice deck file as first argument (technically desribed [here](https://github.com/Cockatrice/Cockatrice/blob/master/doc/deck.xsd)).
